...
<title>Portfolio Pâtisserie</title>
<style>
  /* Styles optimisés pour affichage d'images */
  body {
  ...
  header h1 {
    ...
    letter-spacing: 3px;
    color: #fff8e1;
    text-shadow: 1px 1px 2px #6d3600;
  }
  ...
  main {
    ...
    border-radius: 16px;
    box-shadow: 0 0 20px rgba(255, 175, 0, 0.4);
    text-align: center;
  }
  section {
    margin-bottom: 60px;
  ...
  section h2 {
    border-bottom: 3px solid #d9a92f;
    padding-bottom: 12px;
    margin-bottom: 25px;
    font-weight: 700;
    font-size: 2em;
...
.</p>
    <img id="moodboardimage" src="Mood Board.JPG" alt="Mood board" width="900" height="600"/>
    <p></p>
    <p>
    </p>
  </section>
...
Cependant, mon intention profonde est restée la même : créer une pièce imposante par son volume, mais légère, dynamique, et capable de donner l’impression de prendre vie. 
    ...
    <div class="gallery-block">
      ...
      <div class="gallery-grid">
        ...
        <img src="IMG_0719.jpeg"/>
        <img src="IMG_0720.jpeg"/>
        <img src="IMG_0721.jpeg"/>
        <img src="18.jpg"  />
        <img src="19.jpg"  />
        <img src="20.jpg"  />
        <img src="21.jpg" />
